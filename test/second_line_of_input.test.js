...
import {getRoverposition} from '../src/second_line_of_input';
...
describe("This is a parameterised test to get the rover position. The test below demonstrates that the code handles extra space and is not case sensitive. ", () => {
  ...
  `('Upper Right Coordinates : $upperRightCoordinates, Start Position: {$startPosition.xycoordinates, direction: "$startPosition.direction"} . Test successful for "$movement" with a result : $result', ({upperRightCoordinates,startPosition,movement,result}) => {
